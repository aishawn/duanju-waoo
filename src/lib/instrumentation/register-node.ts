/**
 * Node-only instrumentation: Prisma, BullMQ, Redis, file logging.
 * Loaded only from `src/instrumentation.ts` when `NEXT_RUNTIME === 'nodejs'`
 * so Edge Instrumentation bundles do not trace Prisma / setImmediate.
 */
